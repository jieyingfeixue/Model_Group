...
// 标签体系
export function listSchemas()                   { return request.get('/admin/schemas') }
...
export function deprecateCategory(sid, cid, data) {
  return request.delete(`/admin/schemas/${sid}/categories/${cid}`, { data: data || { reason: 'deprecated' } })
}
