...
export function getModelLineage(id)              { return request.get(`/models/${id}/lineage`) }
export function getModelVersion(id, versionId)   { return request.get(`/models/${id}/versions/${versionId}`) }
...
export function getTrainLogs(id)                 { return request.get(`/train/tasks/${id}/logs`) }
...
export function getInferVisualizeUrl(taskId, imageId) {
  return `/api/infer/tasks/${taskId}/visualize/${imageId}`
}
